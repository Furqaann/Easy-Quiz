...
public class PFQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pfquestions);
        ...
        submitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    marks=correct;
                    Intent in = new Intent(getApplicationContext(), PFResultActivity.class);
                    startActivity(in);
                }
                radio_g.clearCheck();
            }
