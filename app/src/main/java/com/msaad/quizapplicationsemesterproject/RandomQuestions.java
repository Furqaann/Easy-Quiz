...
public class RandomQuestions extends AppCompatActivity {
    ...
    String questions[] = {
            "1011 in Binary is equal to ________ decimal number?",
    ...
    String answers[] = {"11","<=","this","interface","public","import pkg.*","None of the mentioned","java","equals()","int"};
    String opt[] = {
            "1","11","10","0",
            "&","&=","|=","<=",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    marks=correct;
                    Intent in = new Intent(getApplicationContext(), RandomResultActivity.class);
                    startActivity(in);
                }
                radio_g.clearCheck();
            }
